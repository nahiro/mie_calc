...
C   and must be used along with the accompanying files tmq_large.par.f
C   and lpq.f.
...
C   value specified in the PARAMETER statement in the file tmq_large.par.f.
...
C   tmq_large.par.f.  It is recommended to keep NPN1=NPN4+25 and
